...
from src.utils import num_card_account, transactions_xlsx, web_search_xcl
...
def test_transactions_xlsx_valid_file(mocker):
    ...
    """
    fake_data = [{"Категория": "еда", "Сумма": 100}, {"Категория": "транспорт", "Сумма": 50}]
...
def test_web_search_xcl_no_matches():
    ...
    """
    transactions = [{"Категория": "еда", "Сумма": 100}, {"Категория": "транспорт", "Сумма": 50}]
...
def test_web_search_xcl_with_matches():
    ...
    expected_result = json.dumps(
        [{"Категория": "еда", "Сумма": 100}, {"Категория": "Еда", "Сумма": 200}], ensure_ascii=False
    )
...
def test_num_card_account_single_transaction():
    ...
    """
    transactions = [{"Номер карты": "*3456", "Сумма операции с округлением": 150.75}]
    user_input = "*3456"
...
def test_num_card_account_no_transactions():
    ...
    """
    transactions = [{"Номер карты": "*7654", "Сумма операции с округлением": 100.00}]
    user_input = "*3456"
