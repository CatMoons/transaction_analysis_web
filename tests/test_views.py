...
from src.views import get_greeting, parse_datetime, process_excel_data, get_exchange_rate, load_user_settings, get_stock_price
import os
import json
...
def test_process_excel_data_no_matching_records():
    ...
    '''
    data = {
        "Дата операции": ["05-10-2023 12:00:00", "20-10-2023 15:30:00"],
        "Сумма": [100, 200]
    }
...
def test_process_excel_data_invalid_date_format():
    ...
    '''
    data = {
        "Дата операции": ["05-10-2023 12:00:00"],
        "Сумма": [100]
    }
